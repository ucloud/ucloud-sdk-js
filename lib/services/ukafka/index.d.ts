...
export default class UKafkaClient extends Client {
     ...
     */
    addUKafkaInstanceNode(request?: AddUKafkaInstanceNodeRequest): Promise<AddUKafkaInstanceNodeResponse>;
    /**
     ...
     */
    createUKafkaInstance(request?: CreateUKafkaInstanceRequest): Promise<CreateUKafkaInstanceResponse>;
    /**
     * DeleteUKafkaInstance - 删除实例
     *
     * See also: https://docs.ucloud.cn/api/ukafka-api/delete_ukafka_instance
     */
    deleteUKafkaInstance(request?: DeleteUKafkaInstanceRequest): Promise<DeleteUKafkaInstanceResponse>;
    /**
     * DescribeUKafkaConsumer - 获取 Kafka 消费组信息
     *
     * See also: https://docs.ucloud.cn/api/ukafka-api/describe_ukafka_consumer
     */
    describeUKafkaConsumer(request?: DescribeUKafkaConsumerRequest): Promise<DescribeUKafkaConsumerResponse>;
    /**
     ...
     */
    describeUKafkaInstance(request?: DescribeUKafkaInstanceRequest): Promise<DescribeUKafkaInstanceResponse>;
    /**
     * GetUKafkaNodeType - 获取节点机型配置
     *
     * See also: https://docs.ucloud.cn/api/ukafka-api/get_ukafka_node_type
     */
    getUKafkaNodeType(request?: GetUKafkaNodeTypeRequest): Promise<GetUKafkaNodeTypeResponse>;
    /**
     ...
     */
    isUKafkaTopicNameExist(request?: IsUKafkaTopicNameExistRequest): Promise<IsUKafkaTopicNameExistResponse>;
    /**
     * ListUKafkaConsumers - 列出 Kafka 消费组
     *
     * See also: https://docs.ucloud.cn/api/ukafka-api/list_ukafka_consumers
     */
    listUKafkaConsumers(request?: ListUKafkaConsumersRequest): Promise<ListUKafkaConsumersResponse>;
    /**
     * ListUKafkaFrameworkVersion - 列举ukafka框架版本
     *
     * See also: https://docs.ucloud.cn/api/ukafka-api/list_ukafka_framework_version
     */
    listUKafkaFrameworkVersion(request?: ListUKafkaFrameworkVersionRequest): Promise<ListUKafkaFrameworkVersionResponse>;
    /**
     * ListUKafkaInstance - 获取实例列表信息
     *
     * See also: https://docs.ucloud.cn/api/ukafka-api/list_ukafka_instance
     */
    listUKafkaInstance(request?: ListUKafkaInstanceRequest): Promise<ListUKafkaInstanceResponse>;
    /**
     ...
     */
    listUKafkaTopics(request?: ListUKafkaTopicsRequest): Promise<ListUKafkaTopicsResponse>;
    /**
     * ModifyUKafkaInstanceType - 规格升降级，仅升级CPU 和内存
     *
     * See also: https://docs.ucloud.cn/api/ukafka-api/modify_ukafka_instance_type
     */
    modifyUKafkaInstanceType(request?: ModifyUKafkaInstanceTypeRequest): Promise<ModifyUKafkaInstanceTypeResponse>;
    /**
     * ResizeUKafkaDisk - 磁盘扩容
     *
     * See also: https://docs.ucloud.cn/api/ukafka-api/resize_ukafka_disk
     */
    resizeUKafkaDisk(request?: ResizeUKafkaDiskRequest): Promise<ResizeUKafkaDiskResponse>;
}
/**
 * AddUKafkaInstanceNode - 给实例添加节点
 */
