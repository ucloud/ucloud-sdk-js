...
export default class UNetClient extends Client {
     ...
     */
    allocateShareBandwidth(request?: AllocateShareBandwidthRequest): Promise<AllocateShareBandwidthResponse>;
    /**
     * AssociateEIPWithShareBandwidth - 将EIP加入共享带宽
     *
     * See also: https://docs.ucloud.cn/api/unet-api/associate_eip_with_share_bandwidth
     */
    associateEIPWithShareBandwidth(request?: AssociateEIPWithShareBandwidthRequest): Promise<AssociateEIPWithShareBandwidthResponse>;
    /**
     ...
     */
    createFirewall(request?: CreateFirewallRequest): Promise<CreateFirewallResponse>;
    /**
     ...
     */
    deleteFirewall(request?: DeleteFirewallRequest): Promise<DeleteFirewallResponse>;
    /**
     ...
     */
    describeBandwidthUsage(request?: DescribeBandwidthUsageRequest): Promise<DescribeBandwidthUsageResponse>;
    /**
     ...
     */
    describeFirewall(request?: DescribeFirewallRequest): Promise<DescribeFirewallResponse>;
    /**
     * DescribeFirewallResource - 获取防火墙组所绑定资源的外网IP
     *
     * See also: https://docs.ucloud.cn/api/unet-api/describe_firewall_resource
     */
    describeFirewallResource(request?: DescribeFirewallResourceRequest): Promise<DescribeFirewallResourceResponse>;
    /**
     ...
     */
    getEIPPayMode(request?: GetEIPPayModeRequest): Promise<GetEIPPayModeResponse>;
    /**
     ...
     */
    grantFirewall(request?: GrantFirewallRequest): Promise<GrantFirewallResponse>;
    /**
     * ModifyEIPBandwidth - 调整弹性IP的外网带宽
     *
     * See also: https://docs.ucloud.cn/api/unet-api/modify_eip_bandwidth
     */
    modifyEIPBandwidth(request?: ModifyEIPBandwidthRequest): Promise<ModifyEIPBandwidthResponse>;
    /**
     * ModifyEIPWeight - 修改弹性IP的外网出口权重
     *
     * See also: https://docs.ucloud.cn/api/unet-api/modify_eip_weight
     */
    modifyEIPWeight(request?: ModifyEIPWeightRequest): Promise<ModifyEIPWeightResponse>;
    /**
     ...
     */
    releaseShareBandwidth(request?: ReleaseShareBandwidthRequest): Promise<ReleaseShareBandwidthResponse>;
    /**
     * ResizeShareBandwidth - 调整共享带宽的带宽值
     *
     * See also: https://docs.ucloud.cn/api/unet-api/resize_share_bandwidth
     */
    resizeShareBandwidth(request?: ResizeShareBandwidthRequest): Promise<ResizeShareBandwidthResponse>;
    /**
     * SetEIPPayMode - 设置弹性IP计费模式, 切换时会涉及付费/退费.
     *
     * See also: https://docs.ucloud.cn/api/unet-api/set_eip_pay_mode
     */
    setEIPPayMode(request?: SetEIPPayModeRequest): Promise<SetEIPPayModeResponse>;
    /**
     ...
     */
    updateEIPAttribute(request?: UpdateEIPAttributeRequest): Promise<UpdateEIPAttributeResponse>;
    /**
     * UpdateFirewall - 更新防火墙规则
     *
     * See also: https://docs.ucloud.cn/api/unet-api/update_firewall
     */
    updateFirewall(request?: UpdateFirewallRequest): Promise<UpdateFirewallResponse>;
    /**
     * UpdateFirewallAttribute - 更新防火墙规则
     *
     * See also: https://docs.ucloud.cn/api/unet-api/update_firewall_attribute
     */
    updateFirewallAttribute(request?: UpdateFirewallAttributeRequest): Promise<UpdateFirewallAttributeResponse>;
}
/**
 * AllocateEIP - 根据提供信息, 申请弹性IP
 */
