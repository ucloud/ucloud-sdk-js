...
export default class UHadoopClient extends Client {
     ...
     */
    addUHadoopInstanceNode(request?: AddUHadoopInstanceNodeRequest): Promise<AddUHadoopInstanceNodeResponse>;
    /**
     ...
     */
    createUHadoopInstance(request?: CreateUHadoopInstanceRequest): Promise<CreateUHadoopInstanceResponse>;
    /**
     * DeleteUHadoopInstance - 删除掉一个uhadoop集群
     *
     * See also: https://docs.ucloud.cn/api/uhadoop-api/delete_uhadoop_instance
     */
    deleteUHadoopInstance(request?: DeleteUHadoopInstanceRequest): Promise<DeleteUHadoopInstanceResponse>;
    /**
     * DescribeUHadoopInstance - 描述集群
     *
     * See also: https://docs.ucloud.cn/api/uhadoop-api/describe_uhadoop_instance
     */
    describeUHadoopInstance(request?: DescribeUHadoopInstanceRequest): Promise<DescribeUHadoopInstanceResponse>;
    /**
     * GetUHadoopNodeType - 获取节点类型信息
     *
     * See also: https://docs.ucloud.cn/api/uhadoop-api/get_uhadoop_node_type
     */
    getUHadoopNodeType(request?: GetUHadoopNodeTypeRequest): Promise<GetUHadoopNodeTypeResponse>;
    /**
     * ListUHadoopFrameworkApp - 列举可选app
     *
     * See also: https://docs.ucloud.cn/api/uhadoop-api/list_uhadoop_framework_app
     */
    listUHadoopFrameworkApp(request?: ListUHadoopFrameworkAppRequest): Promise<ListUHadoopFrameworkAppResponse>;
    /**
     ...
     */
    listUHadoopFrameworkAppByUseCase(request?: ListUHadoopFrameworkAppByUseCaseRequest): Promise<ListUHadoopFrameworkAppByUseCaseResponse>;
    /**
     * ListUHadoopInstance - 列出用户所有的uhadoop集群
     *
     * See also: https://docs.ucloud.cn/api/uhadoop-api/list_uhadoop_instance
     */
    listUHadoopInstance(request?: ListUHadoopInstanceRequest): Promise<ListUHadoopInstanceResponse>;
    /**
     * RestartUHadoopService - 重启集群服务（包含start|stop|restart）
     *
     * See also: https://docs.ucloud.cn/api/uhadoop-api/restart_uhadoop_service
     */
    restartUHadoopService(request?: RestartUHadoopServiceRequest): Promise<RestartUHadoopServiceResponse>;
    /**
     * UpgradeUHadoopNode - 升级uhadoop节点
     *
     * See also: https://docs.ucloud.cn/api/uhadoop-api/upgrade_uhadoop_node
     */
    upgradeUHadoopNode(request?: UpgradeUHadoopNodeRequest): Promise<UpgradeUHadoopNodeResponse>;
    /**
     * UpgradeUHadoopNodeDisk - 扩容集群节点磁盘
     *
     * See also: https://docs.ucloud.cn/api/uhadoop-api/upgrade_uhadoop_node_disk
     */
    upgradeUHadoopNodeDisk(request?: UpgradeUHadoopNodeDiskRequest): Promise<UpgradeUHadoopNodeDiskResponse>;
}
/**
 * AddUHadoopInstanceNode - 给已有集群添加一定数量的节点
 */
