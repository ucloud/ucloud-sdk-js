...
export default class CubeClient extends Client {
     ...
     */
    createCubeDeployment(request?: CreateCubeDeploymentRequest): Promise<CreateCubeDeploymentResponse>;
    /**
     * CreateCubePod - 创建Pod
     *
     * See also: https://docs.ucloud.cn/api/cube-api/create_cube_pod
     */
    createCubePod(request?: CreateCubePodRequest): Promise<CreateCubePodResponse>;
    /**
     * DeleteCubeDeployment - 删除Cube的Deployment
     *
     * See also: https://docs.ucloud.cn/api/cube-api/delete_cube_deployment
     */
    deleteCubeDeployment(request?: DeleteCubeDeploymentRequest): Promise<DeleteCubeDeploymentResponse>;
    /**
     * DeleteCubePod - 删除Pod
     *
     * See also: https://docs.ucloud.cn/api/cube-api/delete_cube_pod
     */
    deleteCubePod(request?: DeleteCubePodRequest): Promise<DeleteCubePodResponse>;
    /**
     ...
     */
    getCubeExtendInfo(request?: GetCubeExtendInfoRequest): Promise<GetCubeExtendInfoResponse>;
    /**
     * GetCubeMetrics - 获取Cube实例（Pod，PodX，Deploy等）监控数据时间序列
     *
     * See also: https://docs.ucloud.cn/api/cube-api/get_cube_metrics
     */
    getCubeMetrics(request?: GetCubeMetricsRequest): Promise<GetCubeMetricsResponse>;
    /**
     ...
     */
    modifyCubeExtendInfo(request?: ModifyCubeExtendInfoRequest): Promise<ModifyCubeExtendInfoResponse>;
    /**
     ...
     */
    updateCubeDeployment(request?: UpdateCubeDeploymentRequest): Promise<UpdateCubeDeploymentResponse>;
}
/**
 * CreateCubeDeployment - 创建Cube的Deployment
 */
