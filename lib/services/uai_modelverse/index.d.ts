...
export default class UAIModelverseClient extends Client {
     ...
     */
    getUMInferService(request?: GetUMInferServiceRequest): Promise<GetUMInferServiceResponse>;
    /**
     ...
     */
    listUFSquareModelLen(request?: ListUFSquareModelLenRequest): Promise<ListUFSquareModelLenResponse>;
    /**
