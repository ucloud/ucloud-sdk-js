...
export default class UMongoDBClient extends Client {
     ...
     */
    backupUMongoDBCluster(request?: BackupUMongoDBClusterRequest): Promise<BackupUMongoDBClusterResponse>;
    /**
     * BackupUMongoDBLog - 日志打包
     *
     * See also: https://docs.ucloud.cn/api/umongodb-api/backup_umon_go_db_log
     */
    backupUMongoDBLog(request?: BackupUMongoDBLogRequest): Promise<BackupUMongoDBLogResponse>;
    /**
     * CreateUMongoDBConfigTemplate - 创建配置模板
     *
     * See also: https://docs.ucloud.cn/api/umongodb-api/create_umon_go_db_config_template
     */
    createUMongoDBConfigTemplate(request?: CreateUMongoDBConfigTemplateRequest): Promise<CreateUMongoDBConfigTemplateResponse>;
    /**
     * CreateUMongoDBReplSet - 创建一个Mongodb副本集群
     *
     * See also: https://docs.ucloud.cn/api/umongodb-api/create_umon_go_db_repl_set
     */
    createUMongoDBReplSet(request?: CreateUMongoDBReplSetRequest): Promise<CreateUMongoDBReplSetResponse>;
    /**
     ...
     */
    createUMongoDBShardedCluster(request?: CreateUMongoDBShardedClusterRequest): Promise<CreateUMongoDBShardedClusterResponse>;
    /**
     * DescribeUMongoDBBackupURL - 获取实例备份下载链接
     *
     * See also: https://docs.ucloud.cn/api/umongodb-api/describe_umon_go_db_backup_url
     */
    describeUMongoDBBackupURL(request?: DescribeUMongoDBBackupURLRequest): Promise<DescribeUMongoDBBackupURLResponse>;
    /**
     * DescribeUMongoDBInstance - 描述MongoDB实例
     *
     * See also: https://docs.ucloud.cn/api/umongodb-api/describe_umon_go_db_instance
     */
    describeUMongoDBInstance(request?: DescribeUMongoDBInstanceRequest): Promise<DescribeUMongoDBInstanceResponse>;
    /**
     * GetUMongoDBBackupParam - 获取实例备份策略
     *
     * See also: https://docs.ucloud.cn/api/umongodb-api/get_umon_go_db_backup_param
     */
    getUMongoDBBackupParam(request?: GetUMongoDBBackupParamRequest): Promise<GetUMongoDBBackupParamResponse>;
    /**
     * GetUMongoDBCfgTempItem - 获取配置模板内容
     *
     * See also: https://docs.ucloud.cn/api/umongodb-api/get_umon_go_db_cfg_temp_item
     */
    getUMongoDBCfgTempItem(request?: GetUMongoDBCfgTempItemRequest): Promise<GetUMongoDBCfgTempItemResponse>;
    /**
     * GetUMongoDBLog - 查询某一段时间内集群节点的错误日志或慢查询日志
     *
     * See also: https://docs.ucloud.cn/api/umongodb-api/get_umon_go_db_log
     */
    getUMongoDBLog(request?: GetUMongoDBLogRequest): Promise<GetUMongoDBLogResponse>;
    /**
     ...
     */
    getUMongoDBRecoverTimeRange(request?: GetUMongoDBRecoverTimeRangeRequest): Promise<GetUMongoDBRecoverTimeRangeResponse>;
    /**
     * ListUMongoDBBackup - 拉取实例备份列表
     *
     * See also: https://docs.ucloud.cn/api/umongodb-api/list_umon_go_db_backup
     */
    listUMongoDBBackup(request?: ListUMongoDBBackupRequest): Promise<ListUMongoDBBackupResponse>;
    /**
     * ListUMongoDBConfigTemplate - 拉取配置模板
     *
     * See also: https://docs.ucloud.cn/api/umongodb-api/list_umon_go_db_config_template
     */
    listUMongoDBConfigTemplate(request?: ListUMongoDBConfigTemplateRequest): Promise<ListUMongoDBConfigTemplateResponse>;
    /**
     * ListUMongoDBInstances - 获取副本集/分片集群列表
     *
     * See also: https://docs.ucloud.cn/api/umongodb-api/list_umon_go_db_instances
     */
    listUMongoDBInstances(request?: ListUMongoDBInstancesRequest): Promise<ListUMongoDBInstancesResponse>;
    /**
     * ListUMongoDBLogPackage - 日志打包列表
     *
     * See also: https://docs.ucloud.cn/api/umongodb-api/list_umon_go_db_log_package
     */
    listUMongoDBLogPackage(request?: ListUMongoDBLogPackageRequest): Promise<ListUMongoDBLogPackageResponse>;
    /**
     * ListUMongoDBMachineSpec - 获取UMongoDB支持机器类型列表
     *
     * See also: https://docs.ucloud.cn/api/umongodb-api/list_umon_go_db_machine_spec
     */
    listUMongoDBMachineSpec(request?: ListUMongoDBMachineSpecRequest): Promise<ListUMongoDBMachineSpecResponse>;
    /**
     * ListUMongoDBMachineType - 获取UmongDB支持机器类型列表
     *
     * See also: https://docs.ucloud.cn/api/umongodb-api/list_umon_go_db_machine_type
     */
    listUMongoDBMachineType(request?: ListUMongoDBMachineTypeRequest): Promise<ListUMongoDBMachineTypeResponse>;
    /**
     * ListUMongoDBVersion - 获取UMongoDB支持版本列表
     *
     * See also: https://docs.ucloud.cn/api/umongodb-api/list_umon_go_db_version
     */
    listUMongoDBVersion(request?: ListUMongoDBVersionRequest): Promise<ListUMongoDBVersionResponse>;
    /**
     ...
     */
    modifyUMongoDBAdminPassword(request?: ModifyUMongoDBAdminPasswordRequest): Promise<ModifyUMongoDBAdminPasswordResponse>;
    /**
     * ModifyUMongoDBAttribute - 修改MongoDB集群名称
     *
     * See also: https://docs.ucloud.cn/api/umongodb-api/modify_umon_go_db_attribute
     */
    modifyUMongoDBAttribute(request?: ModifyUMongoDBAttributeRequest): Promise<ModifyUMongoDBAttributeResponse>;
    /**
     * ModifyUMongoDBBackupParam - 修改实例备份策略
     *
     * See also: https://docs.ucloud.cn/api/umongodb-api/modify_umon_go_db_backup_param
     */
    modifyUMongoDBBackupParam(request?: ModifyUMongoDBBackupParamRequest): Promise<ModifyUMongoDBBackupParamResponse>;
    /**
     * ResizeUMongoDBInstance - 集群配置升降级
     *
     * See also: https://docs.ucloud.cn/api/umongodb-api/resize_umon_go_db_instance
     */
    resizeUMongoDBInstance(request?: ResizeUMongoDBInstanceRequest): Promise<ResizeUMongoDBInstanceResponse>;
    /**
     * RestartUMongoDBCluster - 重启集群
     *
     * See also: https://docs.ucloud.cn/api/umongodb-api/restart_umon_go_db_cluster
     */
    restartUMongoDBCluster(request?: RestartUMongoDBClusterRequest): Promise<RestartUMongoDBClusterResponse>;
    /**
     * StartUMongoDBCluster - 启动集群
     *
     * See also: https://docs.ucloud.cn/api/umongodb-api/start_umon_go_db_cluster
     */
    startUMongoDBCluster(request?: StartUMongoDBClusterRequest): Promise<StartUMongoDBClusterResponse>;
    /**
     * StopUMongoDBCluster - 停止集群
     *
     * See also: https://docs.ucloud.cn/api/umongodb-api/stop_umon_go_db_cluster
     */
    stopUMongoDBCluster(request?: StopUMongoDBClusterRequest): Promise<StopUMongoDBClusterResponse>;
}
/**
 * BackupUMongoDBCluster - 备份集群数据库
 */
