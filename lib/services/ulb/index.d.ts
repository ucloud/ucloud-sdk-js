...
export default class ULBClient extends Client {
     ...
     */
    addSSLBinding(request?: AddSSLBindingRequest): Promise<AddSSLBindingResponse>;
    /**
     ...
     */
    createSecurityPolicy(request?: CreateSecurityPolicyRequest): Promise<CreateSecurityPolicyResponse>;
    /**
     ...
     */
    deleteSSLBinding(request?: DeleteSSLBindingRequest): Promise<DeleteSSLBindingResponse>;
    /**
     * DeleteSecurityPolicy - 删除安全策略
     *
     * See also: https://docs.ucloud.cn/api/ulb-api/delete_security_policy
     */
    deleteSecurityPolicy(request?: DeleteSecurityPolicyRequest): Promise<DeleteSecurityPolicyResponse>;
    /**
     ...
     */
    describeListeners(request?: DescribeListenersRequest): Promise<DescribeListenersResponse>;
    /**
     ...
     */
    describeSSLV2(request?: DescribeSSLV2Request): Promise<DescribeSSLV2Response>;
    /**
     ...
     */
    describeSecurityPolicies(request?: DescribeSecurityPoliciesRequest): Promise<DescribeSecurityPoliciesResponse>;
    /**
     ...
     */
    describeSecurityPoliciesV2(request?: DescribeSecurityPoliciesV2Request): Promise<DescribeSecurityPoliciesV2Response>;
    /**
     * DescribeSupportCiphers - 返回安全策略所有支持的加密套件
     *
     * See also: https://docs.ucloud.cn/api/ulb-api/describe_support_ciphers
     */
    describeSupportCiphers(request?: DescribeSupportCiphersRequest): Promise<DescribeSupportCiphersResponse>;
    /**
     ...
     */
    removeTargets(request?: RemoveTargetsRequest): Promise<RemoveTargetsResponse>;
    /**
     * UnBindSecurityPolicy - 批量解绑安全策略，会同时解绑与传统型和应用型负载均衡监听器的绑定关系
     *
     * See also: https://docs.ucloud.cn/api/ulb-api/un_bind_security_policy
     */
    unBindSecurityPolicy(request?: UnBindSecurityPolicyRequest): Promise<UnBindSecurityPolicyResponse>;
    /**
     ...
     */
    updateBackendBatch(request?: UpdateBackendBatchRequest): Promise<UpdateBackendBatchResponse>;
    /**
     * UpdateListenerAttribute - 更新一个应用型负载均衡监听器的属性
     *
     * See also: https://docs.ucloud.cn/api/ulb-api/update_listener_attribute
     */
    updateListenerAttribute(request?: UpdateListenerAttributeRequest): Promise<UpdateListenerAttributeResponse>;
    /**
     * UpdateLoadBalancerAttribute - 更新一个应用型负载均衡实例的属性
     *
     * See also: https://docs.ucloud.cn/api/ulb-api/update_load_balancer_attribute
     */
    updateLoadBalancerAttribute(request?: UpdateLoadBalancerAttributeRequest): Promise<UpdateLoadBalancerAttributeResponse>;
    /**
     ...
     */
    updateRuleAttribute(request?: UpdateRuleAttributeRequest): Promise<UpdateRuleAttributeResponse>;
    /**
     ...
     */
    updateSSLBinding(request?: UpdateSSLBindingRequest): Promise<UpdateSSLBindingResponse>;
    /**
     * UpdateSecurityPolicy - 更新安全策略
     *
     * See also: https://docs.ucloud.cn/api/ulb-api/update_security_policy
     */
    updateSecurityPolicy(request?: UpdateSecurityPolicyRequest): Promise<UpdateSecurityPolicyResponse>;
    /**
     * UpdateTargetsAttribute - 更新应用型负载均衡监听器后端服务节点的属性
     *
     * See also: https://docs.ucloud.cn/api/ulb-api/update_targets_attribute
     */
    updateTargetsAttribute(request?: UpdateTargetsAttributeRequest): Promise<UpdateTargetsAttributeResponse>;
    /**
