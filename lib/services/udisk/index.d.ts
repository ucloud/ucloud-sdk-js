...
export default class UDiskClient extends Client {
     ...
     */
    cloneUDiskSnapshot(request?: CloneUDiskSnapshotRequest): Promise<CloneUDiskSnapshotResponse>;
    /**
     * CloneUDiskUDataArk - 从数据方舟的备份创建UDisk
     *
     * See also: https://docs.ucloud.cn/api/udisk-api/clone_udisk_udataark
     */
    cloneUDiskUDataArk(request?: CloneUDiskUDataArkRequest): Promise<CloneUDiskUDataArkResponse>;
    /**
     * CreateAttachUDisk - 创建并挂载UDisk磁盘
     *
     * See also: https://docs.ucloud.cn/api/udisk-api/create_attach_udisk
     */
    createAttachUDisk(request?: CreateAttachUDiskRequest): Promise<CreateAttachUDiskResponse>;
    /**
     ...
     */
    createUDiskSnapshot(request?: CreateUDiskSnapshotRequest): Promise<CreateUDiskSnapshotResponse>;
    /**
     * DeleteUDisk - 删除UDisk
     *
     ...
     */
    deleteUDiskSnapshot(request?: DeleteUDiskSnapshotRequest): Promise<DeleteUDiskSnapshotResponse>;
    /**
     * DescribeRecycleUDisk - 拉取回收站中云硬盘列表
     *
     * See also: https://docs.ucloud.cn/api/udisk-api/describe_recycle_udisk
     */
    describeRecycleUDisk(request?: DescribeRecycleUDiskRequest): Promise<DescribeRecycleUDiskResponse>;
    /**
     * DescribeUDisk - 获取UDisk实例
     *
     * See also: https://docs.ucloud.cn/api/udisk-api/describe_udisk
     */
    describeUDisk(request?: DescribeUDiskRequest): Promise<DescribeUDiskResponse>;
    /**
     * DescribeUDiskPrice - 获取UDisk实例价格信息
     *
     * See also: https://docs.ucloud.cn/api/udisk-api/describe_udisk_price
     */
    describeUDiskPrice(request?: DescribeUDiskPriceRequest): Promise<DescribeUDiskPriceResponse>;
    /**
     * DescribeUDiskSnapshot - 获取UDisk快照
     *
     * See also: https://docs.ucloud.cn/api/udisk-api/describe_udisk_snapshot
     */
    describeUDiskSnapshot(request?: DescribeUDiskSnapshotRequest): Promise<DescribeUDiskSnapshotResponse>;
    /**
     * DescribeUDiskUpgradePrice - 获取UDisk升级价格信息
     *
     * See also: https://docs.ucloud.cn/api/udisk-api/describe_udisk_upgrade_price
     */
    describeUDiskUpgradePrice(request?: DescribeUDiskUpgradePriceRequest): Promise<DescribeUDiskUpgradePriceResponse>;
    /**
     ...
     */
    setUDiskUDataArkMode(request?: SetUDiskUDataArkModeRequest): Promise<SetUDiskUDataArkModeResponse>;
}
/**
 * AttachUDisk - 将一个可用的UDisk挂载到某台主机上，当UDisk挂载成功后，还需要在主机内部进行文件系统操作
 */
