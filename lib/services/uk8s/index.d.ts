...
export default class UK8SClient extends Client {
     ...
     */
    getClusterConfig(request?: GetClusterConfigRequest): Promise<GetClusterConfigResponse>;
    /**
     * GetUK8SVersions - 获取支持创建的UK8S集群版本、Containerd版本
     *
     * See also: https://docs.ucloud.cn/api/uk8s-api/get_uk8s_versions
     */
    getUK8SVersions(request?: GetUK8SVersionsRequest): Promise<GetUK8SVersionsResponse>;
    /**
