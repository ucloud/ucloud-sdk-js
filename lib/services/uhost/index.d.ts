...
export default class UHostClient extends Client {
     ...
     */
    checkUHostResourceCapacity(request?: CheckUHostResourceCapacityRequest): Promise<CheckUHostResourceCapacityResponse>;
    /**
     ...
     */
    describeHostMachineTypeFamilies(request?: DescribeHostMachineTypeFamiliesRequest): Promise<DescribeHostMachineTypeFamiliesResponse>;
    /**
     ...
     */
    describeUHostAvailableDiskTypes(request?: DescribeUHostAvailableDiskTypesRequest): Promise<DescribeUHostAvailableDiskTypesResponse>;
    /**
     ...
     */
    getUHostRefundPrice(request?: GetUHostRefundPriceRequest): Promise<GetUHostRefundPriceResponse>;
    /**
     * GetUHostRenewPrice - 获取主机续费价格
     *
     * See also: https://docs.ucloud.cn/api/uhost-api/get_uhost_renew_price
     */
    getUHostRenewPrice(request?: GetUHostRenewPriceRequest): Promise<GetUHostRenewPriceResponse>;
    /**
