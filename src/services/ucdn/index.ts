...
export default class UCDNClient extends Client {
  ...
  getNewUcdnDomainBandwidth(
    request?: GetNewUcdnDomainBandwidthRequest
  ): Promise<GetNewUcdnDomainBandwidthResponse> {
    const args = { Action: 'GetNewUcdnDomainBandwidth', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as GetNewUcdnDomainBandwidthResponse
    );
  }
  ...
  getNewUcdnDomainHttpCode(
    request?: GetNewUcdnDomainHttpCodeRequest
  ): Promise<GetNewUcdnDomainHttpCodeResponse> {
    const args = { Action: 'GetNewUcdnDomainHttpCode', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as GetNewUcdnDomainHttpCodeResponse
    );
  }
  ...
  getNewUcdnDomainHttpCodeV2(
    request?: GetNewUcdnDomainHttpCodeV2Request
  ): Promise<GetNewUcdnDomainHttpCodeV2Response> {
    const args = { Action: 'GetNewUcdnDomainHttpCodeV2', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as GetNewUcdnDomainHttpCodeV2Response
    );
  }
  ...
  getUcdnDomainRequestNumV2(
    request?: GetUcdnDomainRequestNumV2Request
  ): Promise<GetUcdnDomainRequestNumV2Response> {
    const args = { Action: 'GetUcdnDomainRequestNumV2', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as GetUcdnDomainRequestNumV2Response
    );
  }
  ...
  getUcdnDomainTraffic(
    request?: GetUcdnDomainTrafficRequest
  ): Promise<GetUcdnDomainTrafficResponse> {
    const args = { Action: 'GetUcdnDomainTraffic', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as GetUcdnDomainTrafficResponse
    );
  }
  ...
  getUcdnPassBandwidth(
    request?: GetUcdnPassBandwidthRequest
  ): Promise<GetUcdnPassBandwidthResponse> {
    const args = { Action: 'GetUcdnPassBandwidth', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as GetUcdnPassBandwidthResponse
    );
  }
   ...
   */
  getUcdnTraffic(
    request?: GetUcdnTrafficRequest
  ): Promise<GetUcdnTrafficResponse> {
    const args = { Action: 'GetUcdnTraffic', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as GetUcdnTrafficResponse
    );
  }
