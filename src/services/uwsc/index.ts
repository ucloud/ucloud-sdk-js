...
export default class UWSCClient extends Client {
   ...
   */
  addExportLineRules(
    request?: AddExportLineRulesRequest
  ): Promise<AddExportLineRulesResponse> {
    const args = { Action: 'AddExportLineRules', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as AddExportLineRulesResponse
    );
  }
  ...
  bindCPE(request?: BindCPERequest): Promise<BindCPEResponse> {
    const args = { Action: 'BindCPE', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as BindCPEResponse
    );
  }
   ...
   */
  createCEGateway(
    request?: CreateCEGatewayRequest
  ): Promise<CreateCEGatewayResponse> {
    const args = { Action: 'CreateCEGateway', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as CreateCEGatewayResponse
    );
  }
   ...
   */
  createCETunnel(
    request?: CreateCETunnelRequest
  ): Promise<CreateCETunnelResponse> {
    const args = { Action: 'CreateCETunnel', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as CreateCETunnelResponse
    );
  }
  ...
  createCPE(request?: CreateCPERequest): Promise<CreateCPEResponse> {
    const args = { Action: 'CreateCPE', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as CreateCPEResponse
    );
  }
   ...
   */
  createExportLine(
    request?: CreateExportLineRequest
  ): Promise<CreateExportLineResponse> {
    const args = { Action: 'CreateExportLine', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as CreateExportLineResponse
    );
  }
  ...
  createPOPGW(request?: CreatePOPGWRequest): Promise<CreatePOPGWResponse> {
    const args = { Action: 'CreatePOPGW', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as CreatePOPGWResponse
    );
  }
   ...
   */
  deleteCEGateway(
    request?: DeleteCEGatewayRequest
  ): Promise<DeleteCEGatewayResponse> {
    const args = { Action: 'DeleteCEGateway', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as DeleteCEGatewayResponse
    );
  }
   ...
   */
  deleteCETunnel(
    request?: DeleteCETunnelRequest
  ): Promise<DeleteCETunnelResponse> {
    const args = { Action: 'DeleteCETunnel', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as DeleteCETunnelResponse
    );
  }
   ...
   */
  deleteExportLine(
    request?: DeleteExportLineRequest
  ): Promise<DeleteExportLineResponse> {
    const args = { Action: 'DeleteExportLine', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as DeleteExportLineResponse
    );
  }
  ...
  deleteExportLineRules(
    request?: DeleteExportLineRulesRequest
  ): Promise<DeleteExportLineRulesResponse> {
    const args = { Action: 'DeleteExportLineRules', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as DeleteExportLineRulesResponse
    );
  }
  ...
  deletePOPGW(request?: DeletePOPGWRequest): Promise<DeletePOPGWResponse> {
    const args = { Action: 'DeletePOPGW', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as DeletePOPGWResponse
    );
  }
   ...
   */
  describeCEGateway(
    request?: DescribeCEGatewayRequest
  ): Promise<DescribeCEGatewayResponse> {
    const args = { Action: 'DescribeCEGateway', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as DescribeCEGatewayResponse
    );
  }
   ...
   */
  describeCETunnel(
    request?: DescribeCETunnelRequest
  ): Promise<DescribeCETunnelResponse> {
    const args = { Action: 'DescribeCETunnel', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as DescribeCETunnelResponse
    );
  }
  ...
  describeCPE(request?: DescribeCPERequest): Promise<DescribeCPEResponse> {
    const args = { Action: 'DescribeCPE', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as DescribeCPEResponse
    );
  }
   ...
   */
  describeExportLine(
    request?: DescribeExportLineRequest
  ): Promise<DescribeExportLineResponse> {
    const args = { Action: 'DescribeExportLine', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as DescribeExportLineResponse
    );
  }
  ...
  describeExportLineRules(
    request?: DescribeExportLineRulesRequest
  ): Promise<DescribeExportLineRulesResponse> {
    const args = { Action: 'DescribeExportLineRules', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as DescribeExportLineRulesResponse
    );
  }
   ...
   */
  describePOPGW(
    request?: DescribePOPGWRequest
  ): Promise<DescribePOPGWResponse> {
    const args = { Action: 'DescribePOPGW', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as DescribePOPGWResponse
    );
  }
   ...
   */
  listAvailableRegion(
    request?: ListAvailableRegionRequest
  ): Promise<ListAvailableRegionResponse> {
    const args = { Action: 'ListAvailableRegion', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as ListAvailableRegionResponse
    );
  }
   ...
   */
  updateBWPackage(
    request?: UpdateBWPackageRequest
  ): Promise<UpdateBWPackageResponse> {
    const args = { Action: 'UpdateBWPackage', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as UpdateBWPackageResponse
    );
  }
   ...
   */
  updateCEGateway(
    request?: UpdateCEGatewayRequest
  ): Promise<UpdateCEGatewayResponse> {
    const args = { Action: 'UpdateCEGateway', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as UpdateCEGatewayResponse
    );
  }
   ...
   */
  updateCETunnel(
    request?: UpdateCETunnelRequest
  ): Promise<UpdateCETunnelResponse> {
    const args = { Action: 'UpdateCETunnel', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as UpdateCETunnelResponse
    );
  }
   ...
   */
  updateCETunnelAttribute(
    request?: UpdateCETunnelAttributeRequest
  ): Promise<UpdateCETunnelAttributeResponse> {
    const args = { Action: 'UpdateCETunnelAttribute', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as UpdateCETunnelAttributeResponse
    );
  }
   ...
   */
  updateExportLine(
    request?: UpdateExportLineRequest
  ): Promise<UpdateExportLineResponse> {
    const args = { Action: 'UpdateExportLine', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as UpdateExportLineResponse
    );
  }
  ...
  updatePOPGWAttribute(
    request?: UpdatePOPGWAttributeRequest
  ): Promise<UpdatePOPGWAttributeResponse> {
    const args = { Action: 'UpdatePOPGWAttribute', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as UpdatePOPGWAttributeResponse
    );
  }
   ...
   */
  upgradeExportLine(
    request?: UpgradeExportLineRequest
  ): Promise<UpgradeExportLineResponse> {
    const args = { Action: 'UpgradeExportLine', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as UpgradeExportLineResponse
    );
  }
}
