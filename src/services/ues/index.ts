...
export default class UESClient extends Client {
   ...
   */
  createUESInstance(
    request?: CreateUESInstanceRequest
  ): Promise<CreateUESInstanceResponse> {
    const args = { Action: 'CreateUESInstance', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as CreateUESInstanceResponse
    );
  }
   ...
   */
  deleteUESInstance(
    request?: DeleteUESInstanceRequest
  ): Promise<DeleteUESInstanceResponse> {
    const args = { Action: 'DeleteUESInstance', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as DeleteUESInstanceResponse
    );
  }
   ...
   */
  describeUESInstanceV2(
    request?: DescribeUESInstanceV2Request
  ): Promise<DescribeUESInstanceV2Response> {
    const args = { Action: 'DescribeUESInstanceV2', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as DescribeUESInstanceV2Response
    );
  }
   ...
   */
  expandUESInstance(
    request?: ExpandUESInstanceRequest
  ): Promise<ExpandUESInstanceResponse> {
    const args = { Action: 'ExpandUESInstance', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as ExpandUESInstanceResponse
    );
  }
   ...
   */
  getUESAppVersion(
    request?: GetUESAppVersionRequest
  ): Promise<GetUESAppVersionResponse> {
    const args = { Action: 'GetUESAppVersion', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as GetUESAppVersionResponse
    );
  }
   ...
   */
  getUESDiskSizeLimitation(
    request?: GetUESDiskSizeLimitationRequest
  ): Promise<GetUESDiskSizeLimitationResponse> {
    const args = { Action: 'GetUESDiskSizeLimitation', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as GetUESDiskSizeLimitationResponse
    );
  }
   ...
   */
  getUESNodeConf(
    request?: GetUESNodeConfRequest
  ): Promise<GetUESNodeConfResponse> {
    const args = { Action: 'GetUESNodeConf', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as GetUESNodeConfResponse
    );
  }
   ...
   */
  listUESInstance(
    request?: ListUESInstanceRequest
  ): Promise<ListUESInstanceResponse> {
    const args = { Action: 'ListUESInstance', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as ListUESInstanceResponse
    );
  }
   ...
   */
  resizeUESInstance(
    request?: ResizeUESInstanceRequest
  ): Promise<ResizeUESInstanceResponse> {
    const args = { Action: 'ResizeUESInstance', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as ResizeUESInstanceResponse
    );
  }
   ...
   */
  restartUESInstance(
    request?: RestartUESInstanceRequest
  ): Promise<RestartUESInstanceResponse> {
    const args = { Action: 'RestartUESInstance', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as RestartUESInstanceResponse
    );
  }
}
