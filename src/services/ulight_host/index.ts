...
export default class ULightHostClient extends Client {
  ...
  checkULHostResourceCapacity(
    request?: CheckULHostResourceCapacityRequest
  ): Promise<CheckULHostResourceCapacityResponse> {
    const args = { Action: 'CheckULHostResourceCapacity', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as CheckULHostResourceCapacityResponse
    );
  }
  ...
  createULHostInstance(
    request?: CreateULHostInstanceRequest
  ): Promise<CreateULHostInstanceResponse> {
    const args = { Action: 'CreateULHostInstance', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as CreateULHostInstanceResponse
    );
  }
  ...
  describeULHostBundles(
    request?: DescribeULHostBundlesRequest
  ): Promise<DescribeULHostBundlesResponse> {
    const args = { Action: 'DescribeULHostBundles', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as DescribeULHostBundlesResponse
    );
  }
   ...
   */
  describeULHostImage(
    request?: DescribeULHostImageRequest
  ): Promise<DescribeULHostImageResponse> {
    const args = { Action: 'DescribeULHostImage', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as DescribeULHostImageResponse
    );
  }
  ...
  describeULHostInstance(
    request?: DescribeULHostInstanceRequest
  ): Promise<DescribeULHostInstanceResponse> {
    const args = { Action: 'DescribeULHostInstance', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as DescribeULHostInstanceResponse
    );
  }
  ...
  getULHostInstancePrice(
    request?: GetULHostInstancePriceRequest
  ): Promise<GetULHostInstancePriceResponse> {
    const args = { Action: 'GetULHostInstancePrice', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as GetULHostInstancePriceResponse
    );
  }
   ...
   */
  getULHostRenewPrice(
    request?: GetULHostRenewPriceRequest
  ): Promise<GetULHostRenewPriceResponse> {
    const args = { Action: 'GetULHostRenewPrice', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as GetULHostRenewPriceResponse
    );
  }
  ...
  modifyULHostAttribute(
    request?: ModifyULHostAttributeRequest
  ): Promise<ModifyULHostAttributeResponse> {
    const args = { Action: 'ModifyULHostAttribute', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as ModifyULHostAttributeResponse
    );
  }
  ...
  poweroffULHostInstance(
    request?: PoweroffULHostInstanceRequest
  ): Promise<PoweroffULHostInstanceResponse> {
    const args = { Action: 'PoweroffULHostInstance', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as PoweroffULHostInstanceResponse
    );
  }
  ...
  rebootULHostInstance(
    request?: RebootULHostInstanceRequest
  ): Promise<RebootULHostInstanceResponse> {
    const args = { Action: 'RebootULHostInstance', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as RebootULHostInstanceResponse
    );
  }
  ...
  reinstallULHostInstance(
    request?: ReinstallULHostInstanceRequest
  ): Promise<ReinstallULHostInstanceResponse> {
    const args = { Action: 'ReinstallULHostInstance', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as ReinstallULHostInstanceResponse
    );
  }
  ...
  resetULHostInstancePassword(
    request?: ResetULHostInstancePasswordRequest
  ): Promise<ResetULHostInstancePasswordResponse> {
    const args = { Action: 'ResetULHostInstancePassword', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as ResetULHostInstancePasswordResponse
    );
  }
   ...
   */
  startULHostInstance(
    request?: StartULHostInstanceRequest
  ): Promise<StartULHostInstanceResponse> {
    const args = { Action: 'StartULHostInstance', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as StartULHostInstanceResponse
    );
  }
   ...
   */
  stopULHostInstance(
    request?: StopULHostInstanceRequest
  ): Promise<StopULHostInstanceResponse> {
    const args = { Action: 'StopULHostInstance', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as StopULHostInstanceResponse
    );
  }
  ...
  terminateULHostInstance(
    request?: TerminateULHostInstanceRequest
  ): Promise<TerminateULHostInstanceResponse> {
    const args = { Action: 'TerminateULHostInstance', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as TerminateULHostInstanceResponse
    );
  }
}
