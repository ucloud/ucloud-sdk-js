...
/**
 * GetUHostInstancePriceRequestVirtualGpu - 
 */
export interface GetUHostInstancePriceRequestVirtualGpu {
}
...
/**
 * ReinstallUHostInstanceResponse - 
 */
...
/**
 * ResetUHostInstancePasswordRequest - 
 */
...
/**
 * ResetUHostInstancePasswordResponse - 
 */
 ...
 * UHostPriceSet - 
 */
export interface UHostPriceSet {
    /**
 ...
 * UHostInstanceSet - 
 */
export interface UHostInstanceSet {
    /**
...
/**
 * GetUHostInstanceVncInfoRequest - 
 */
...
/**
 * ModifyUHostInstanceNameRequest - 
 */
...
/**
 * CreateUHostInstanceRequestVolumes - 
 */
export interface CreateUHostInstanceRequestVolumes {
}
    
/**
 * TerminateCustomImageRequest - 
 */
...
/**
 * ModifyUHostInstanceRemarkResponse - 
 */
...
export interface GetUHostInstancePriceRequest {
     ...
     */
    Disks?:
            GetUHostInstancePriceRequestDisks[]
    /**
     ...
     */
    Volumes?:
            GetUHostInstancePriceRequestVolumes[]
    /**
     * 
     */
    VirtualGpu?:
...
/**
 * GetAttachedDiskUpgradePriceRequest - 
 */
 ...
 * GetUHostInstancePriceRequestVolumes - 
 */
export interface GetUHostInstancePriceRequestVolumes {
}
    
/**
 * ResizeAttachedDiskRequest - 
 */
...
/**
 * CreateUHostInstanceRequestNetworkInterfaceEIP - 
 */
export interface CreateUHostInstanceRequestNetworkInterfaceEIP {
    /**
...
/**
 * ModifyUHostInstanceRemarkRequest - 
 */
...
/**
 * CreateUHostInstanceRequestNetworkInterfaceIPv6 - 
 */
export interface CreateUHostInstanceRequestNetworkInterfaceIPv6 {
}
...
/**
 * CreateUHostInstanceRequestNetworkInterface - 
 */
export interface CreateUHostInstanceRequestNetworkInterface {
    /**
     * 
     */
    EIP?:
...
/**
 * ModifyUHostInstanceTagResponse - 
 */
 ...
 * GetUHostInstancePriceRequestDisks - 
 */
export interface GetUHostInstancePriceRequestDisks {
    /**
...
/**
 * UpgradeToArkUHostInstanceResponse - 
 */
...
export interface CreateUHostInstanceRequest {
     ...
     */
    Disks?:
            CreateUHostInstanceRequestDisks[]
    /**
     ...
     */
    Features?:
        CreateUHostInstanceRequestFeatures
    /**
...
/**
 * ModifyUHostInstanceNameResponse - 
 */
 ...
 * CreateUHostInstanceRequestFeatures - 
 */
export interface CreateUHostInstanceRequestFeatures {
    /**
 ...
 * UHostImageSet - 
 */
export interface UHostImageSet {
    /**
     * 可用区，参见 [可用区列表](../summary/regionlist.html) 
     */
    Zone?:string
 ...
 * CreateUHostInstanceRequestDisks - 
 */
export interface CreateUHostInstanceRequestDisks {
    /**
     * 是否是系统盘。枚举值：\\ > True，是系统盘 \\ > False，是数据盘（默认）。Disks数组中有且只能有一块盘是系统盘。
     */
    IsBoot:string
...
/**
 * GetAttachedDiskUpgradePriceResponse - 
 */
