...
export default class UHostClient extends Client {
   ...
   */
  copyCustomImage(
    request?: CopyCustomImageRequest
  ...
  createIsolationGroup(
    request?: CreateIsolationGroupRequest
   ...
   */
  createUHostInstance(
    request?: CreateUHostInstanceRequest
   ...
   */
  createUHostKeyPair(
    request?: CreateUHostKeyPairRequest
  ...
  deleteIsolationGroup(
    request?: DeleteIsolationGroupRequest
   ...
   */
  deleteUHostKeyPairs(
    request?: DeleteUHostKeyPairsRequest
  ...
  ): Promise<DescribeAvailableInstanceTypesResponse> {
    const args = {
  ...
  describeIsolationGroup(
    request?: DescribeIsolationGroupRequest
  ...
  describeUHostInstance(
    request?: DescribeUHostInstanceRequest
  ...
  describeUHostKeyPairs(
    request?: DescribeUHostKeyPairsRequest
   ...
   */
  describeUHostTags(
    request?: DescribeUHostTagsRequest
  ...
  getAttachedDiskUpgradePrice(
    request?: GetAttachedDiskUpgradePriceRequest
  ...
  getUHostInstancePrice(
    request?: GetUHostInstancePriceRequest
  ...
  getUHostInstanceVncInfo(
    request?: GetUHostInstanceVncInfoRequest
  ...
  getUHostUpgradePrice(
    request?: GetUHostUpgradePriceRequest
   ...
   */
  importUHostKeyPairs(
    request?: ImportUHostKeyPairsRequest
   ...
   */
  leaveIsolationGroup(
    request?: LeaveIsolationGroupRequest
  ...
  modifyUHostInstanceName(
    request?: ModifyUHostInstanceNameRequest
  ...
  modifyUHostInstanceRemark(
    request?: ModifyUHostInstanceRemarkRequest
  ...
  modifyUHostInstanceTag(
    request?: ModifyUHostInstanceTagRequest
  ...
  poweroffUHostInstance(
    request?: PoweroffUHostInstanceRequest
   ...
   */
  rebootUHostInstance(
    request?: RebootUHostInstanceRequest
  ...
  reinstallUHostInstance(
    request?: ReinstallUHostInstanceRequest
  ...
  resetUHostInstancePassword(
    request?: ResetUHostInstancePasswordRequest
   ...
   */
  resizeAttachedDisk(
    request?: ResizeAttachedDiskRequest
   ...
   */
  resizeUHostInstance(
    request?: ResizeUHostInstanceRequest
   ...
   */
  startUHostInstance(
    request?: StartUHostInstanceRequest
   ...
   */
  stopUHostInstance(
    request?: StopUHostInstanceRequest
  ...
  terminateCustomImage(
    request?: TerminateCustomImageRequest
  ...
  terminateUHostInstance(
    request?: TerminateUHostInstanceRequest
