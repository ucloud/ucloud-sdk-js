...
export default class SandboxClient extends Client {
   ...
   */
  checkSandboxCustomDomain(
    request?: CheckSandboxCustomDomainRequest
  ): Promise<CheckSandboxCustomDomainResponse> {
    const args = { Action: 'CheckSandboxCustomDomain', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as CheckSandboxCustomDomainResponse
    );
  }
   ...
   */
  createSandboxSite(
    request?: CreateSandboxSiteRequest
  ): Promise<CreateSandboxSiteResponse> {
    const args = { Action: 'CreateSandboxSite', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as CreateSandboxSiteResponse
    );
  }
   ...
   */
  deleteSandboxSite(
    request?: DeleteSandboxSiteRequest
  ): Promise<DeleteSandboxSiteResponse> {
    const args = { Action: 'DeleteSandboxSite', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as DeleteSandboxSiteResponse
    );
  }
   ...
   */
  listSandboxSites(
    request?: ListSandboxSitesRequest
  ): Promise<ListSandboxSitesResponse> {
    const args = { Action: 'ListSandboxSites', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as ListSandboxSitesResponse
    );
  }
   ...
   */
  updateSandboxSite(
    request?: UpdateSandboxSiteRequest
  ): Promise<UpdateSandboxSiteResponse> {
    const args = { Action: 'UpdateSandboxSite', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as UpdateSandboxSiteResponse
    );
  }
   ...
   */
  updateSandboxSiteCustomDomain(
    request?: UpdateSandboxSiteCustomDomainRequest
  ): Promise<UpdateSandboxSiteCustomDomainResponse> {
    const args = {
      Action: 'UpdateSandboxSiteCustomDomain',
      ...(request || {}),
    };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as UpdateSandboxSiteCustomDomainResponse
    );
  }
}
