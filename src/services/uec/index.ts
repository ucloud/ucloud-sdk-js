...
export default class UECClient extends Client {
   ...
   */
  bindUEcFirewall(
    request?: BindUEcFirewallRequest
  ...
  createUEcCustomImage(
    request?: CreateUEcCustomImageRequest
   ...
   */
  createUEcFirewall(
    request?: CreateUEcFirewallRequest
   ...
   */
  createUEcHolder(
    request?: CreateUEcHolderRequest
   ...
   */
  createUEcSubnet(
    request?: CreateUEcSubnetRequest
  ...
  deleteUEcCustomImage(
    request?: DeleteUEcCustomImageRequest
   ...
   */
  deleteUEcHolder(
    request?: DeleteUEcHolderRequest
   ...
   */
  deleteUEcSubnet(
    request?: DeleteUEcSubnetRequest
   ...
   */
  describeUEcFirewall(
    request?: DescribeUEcFirewallRequest
  ...
  describeUEcFirewallResource(
    request?: DescribeUEcFirewallResourceRequest
   ...
   */
  describeUEcHolder(
    request?: DescribeUEcHolderRequest
  ...
  describeUEcHolderIDC(
    request?: DescribeUEcHolderIDCRequest
   ...
   */
  describeUEcSubnet(
    request?: DescribeUEcSubnetRequest
   ...
   */
  describeUEcVHost(
    request?: DescribeUEcVHostRequest
   ...
   */
  getUEcHolderLog(
    request?: GetUEcHolderLogRequest
   ...
   */
  getUEcHolderMetrics(
    request?: GetUEcHolderMetricsRequest
   ...
   */
  getUEcIDCCutInfo(
    request?: GetUEcIDCCutInfoRequest
   ...
   */
  getUEcIDCVHostData(
    request?: GetUEcIDCVHostDataRequest
   ...
   */
  getUEcUpgradePrice(
    request?: GetUEcUpgradePriceRequest
   ...
   */
  getUEcVHostData(
    request?: GetUEcVHostDataRequest
   ...
   */
  getUEcVHostPrice(
    request?: GetUEcVHostPriceRequest
  ...
  importUEcCustomImage(
    request?: ImportUEcCustomImageRequest
   ...
   */
  modifyUEcBandwidth(
    request?: ModifyUEcBandwidthRequest
   ...
   */
  modifyUEcHolderName(
    request?: ModifyUEcHolderNameRequest
   ...
   */
  modifyUEcImageName(
    request?: ModifyUEcImageNameRequest
   ...
   */
  poweroffUEcVHost(
    request?: PoweroffUEcVHostRequest
   ...
   */
  reinstallUEcVHost(
    request?: ReinstallUEcVHostRequest
   ...
   */
  restartUEcHolder(
    request?: RestartUEcHolderRequest
   ...
   */
  restartUEcVHost(
    request?: RestartUEcVHostRequest
   ...
   */
  unBindUEcFirewall(
    request?: UnBindUEcFirewallRequest
   ...
   */
  updateUEcFirewall(
    request?: UpdateUEcFirewallRequest
  ...
  updateUEcFirewallAttribute(
    request?: UpdateUEcFirewallAttributeRequest
   ...
   */
  updateUEcSubnet(
    request?: UpdateUEcSubnetRequest
