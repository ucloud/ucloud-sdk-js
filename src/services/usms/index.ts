...
export default class USMSClient extends Client {
   ...
   */
  createUSMSSignature(
    request?: CreateUSMSSignatureRequest
   ...
   */
  createUSMSTemplate(
    request?: CreateUSMSTemplateRequest
   ...
   */
  deleteUSMSSignature(
    request?: DeleteUSMSSignatureRequest
   ...
   */
  deleteUSMSTemplate(
    request?: DeleteUSMSTemplateRequest
   ...
   */
  getUSMSSendReceipt(
    request?: GetUSMSSendReceiptRequest
   ...
   */
  queryUSMSSignature(
    request?: QueryUSMSSignatureRequest
   ...
   */
  queryUSMSTemplate(
    request?: QueryUSMSTemplateRequest
  ...
  sendBatchUSMSMessage(
    request?: SendBatchUSMSMessageRequest
   ...
   */
  sendUSMSMessage(
    request?: SendUSMSMessageRequest
   ...
   */
  updateUSMSSignature(
    request?: UpdateUSMSSignatureRequest
   ...
   */
  updateUSMSTemplate(
    request?: UpdateUSMSTemplateRequest
