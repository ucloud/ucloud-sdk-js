 ...
 * FailPhoneDetail - 
 */
export interface FailPhoneDetail {
    /**
     * 模板参数
     */
...
/**
 * DeleteUSMSSignatureResponse - 
 */
export interface DeleteUSMSSignatureResponse {
}
    
/**
 * GetUSMSSendReceiptRequest - 
 */
 ...
 * ReceiptPerSession - 
 */
export interface ReceiptPerSession {
    /**
     * 发送短信时返回的SessionNo
     */
    SessionNo:string
 ...
 * ReceiptPerPhone - 
 */
export interface ReceiptPerPhone {
    /**
     * 手机号码
     */
    Phone:string
...
/**
 * DeleteUSMSTemplateResponse - 
 */
export interface DeleteUSMSTemplateResponse {
}
    
/**
 * QueryUSMSSignatureResponse - 
 */
