...
export default class UPHostClient extends Client {
   ...
   */
  describePHostImage(
    request?: DescribePHostImageRequest
  ...
  describePHostMachineType(
    request?: DescribePHostMachineTypeRequest
   ...
   */
  describePHostTags(
    request?: DescribePHostTagsRequest
  ...
  getPHostDiskUpgradePrice(
    request?: GetPHostDiskUpgradePriceRequest
   ...
   */
  modifyPHostInfo(
    request?: ModifyPHostInfoRequest
   ...
   */
  resetPHostPassword(
    request?: ResetPHostPasswordRequest
  ...
  resizePHostAttachedDisk(
    request?: ResizePHostAttachedDiskRequest
