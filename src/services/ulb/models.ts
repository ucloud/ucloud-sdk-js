 ...
 * ULBVServerSet - 
 */
export interface ULBVServerSet {
    /**
 ...
 * PolicyBackendSet - 
 */
export interface PolicyBackendSet {
    /**
 ...
 * ULBBackendSet - 
 */
export interface ULBBackendSet {
    /**
     * 后端资源实例的Id
     */
    BackendId?:string
