...
export default class ULogServiceClient extends Client {
   ...
   */
  bindULogServiceGroupToCollectConf(
    request?: BindULogServiceGroupToCollectConfRequest
  ): Promise<BindULogServiceGroupToCollectConfResponse> {
    const args = {
      Action: 'BindULogServiceGroupToCollectConf',
      ...(request || {}),
    };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as BindULogServiceGroupToCollectConfResponse
    );
  }
   ...
   */
  createULogServiceCollectConf(
    request?: CreateULogServiceCollectConfRequest
  ): Promise<CreateULogServiceCollectConfResponse> {
    const args = { Action: 'CreateULogServiceCollectConf', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as CreateULogServiceCollectConfResponse
    );
  }
   ...
   */
  createULogServiceLogSet(
    request?: CreateULogServiceLogSetRequest
  ): Promise<CreateULogServiceLogSetResponse> {
    const args = { Action: 'CreateULogServiceLogSet', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as CreateULogServiceLogSetResponse
    );
  }
   ...
   */
  createULogServiceMachineGroup(
    request?: CreateULogServiceMachineGroupRequest
  ): Promise<CreateULogServiceMachineGroupResponse> {
    const args = {
      Action: 'CreateULogServiceMachineGroup',
      ...(request || {}),
    };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as CreateULogServiceMachineGroupResponse
    );
  }
   ...
   */
  createULogServiceTopic(
    request?: CreateULogServiceTopicRequest
  ): Promise<CreateULogServiceTopicResponse> {
    const args = { Action: 'CreateULogServiceTopic', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as CreateULogServiceTopicResponse
    );
  }
   ...
   */
  deleteULogServiceCollectConf(
    request?: DeleteULogServiceCollectConfRequest
  ): Promise<DeleteULogServiceCollectConfResponse> {
    const args = { Action: 'DeleteULogServiceCollectConf', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as DeleteULogServiceCollectConfResponse
    );
  }
   ...
   */
  deleteULogServiceLogSet(
    request?: DeleteULogServiceLogSetRequest
  ): Promise<DeleteULogServiceLogSetResponse> {
    const args = { Action: 'DeleteULogServiceLogSet', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as DeleteULogServiceLogSetResponse
    );
  }
   ...
   */
  deleteULogServiceMachineGroup(
    request?: DeleteULogServiceMachineGroupRequest
  ): Promise<DeleteULogServiceMachineGroupResponse> {
    const args = {
      Action: 'DeleteULogServiceMachineGroup',
      ...(request || {}),
    };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as DeleteULogServiceMachineGroupResponse
    );
  }
   ...
   */
  deleteULogServiceTopic(
    request?: DeleteULogServiceTopicRequest
  ): Promise<DeleteULogServiceTopicResponse> {
    const args = { Action: 'DeleteULogServiceTopic', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as DeleteULogServiceTopicResponse
    );
  }
   ...
   */
  describeULogServiceMachineGroup(
    request?: DescribeULogServiceMachineGroupRequest
  ): Promise<DescribeULogServiceMachineGroupResponse> {
    const args = {
      Action: 'DescribeULogServiceMachineGroup',
      ...(request || {}),
    };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as DescribeULogServiceMachineGroupResponse
    );
  }
   ...
   */
  getULogServiceTopicField(
    request?: GetULogServiceTopicFieldRequest
  ): Promise<GetULogServiceTopicFieldResponse> {
    const args = { Action: 'GetULogServiceTopicField', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as GetULogServiceTopicFieldResponse
    );
  }
   ...
   */
  listULogServiceCollectConf(
    request?: ListULogServiceCollectConfRequest
  ): Promise<ListULogServiceCollectConfResponse> {
    const args = { Action: 'ListULogServiceCollectConf', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as ListULogServiceCollectConfResponse
    );
  }
   ...
   */
  listULogServiceLogSet(
    request?: ListULogServiceLogSetRequest
  ): Promise<ListULogServiceLogSetResponse> {
    const args = { Action: 'ListULogServiceLogSet', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as ListULogServiceLogSetResponse
    );
  }
   ...
   */
  listULogServiceMachineGroup(
    request?: ListULogServiceMachineGroupRequest
  ): Promise<ListULogServiceMachineGroupResponse> {
    const args = { Action: 'ListULogServiceMachineGroup', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as ListULogServiceMachineGroupResponse
    );
  }
   ...
   */
  listULogServiceTopic(
    request?: ListULogServiceTopicRequest
  ): Promise<ListULogServiceTopicResponse> {
    const args = { Action: 'ListULogServiceTopic', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as ListULogServiceTopicResponse
    );
  }
   ...
   */
  queryULogServiceLog(
    request?: QueryULogServiceLogRequest
  ): Promise<QueryULogServiceLogResponse> {
    const args = { Action: 'QueryULogServiceLog', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as QueryULogServiceLogResponse
    );
  }
   ...
   */
  updateULogServiceCollectConf(
    request?: UpdateULogServiceCollectConfRequest
  ): Promise<UpdateULogServiceCollectConfResponse> {
    const args = { Action: 'UpdateULogServiceCollectConf', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as UpdateULogServiceCollectConfResponse
    );
  }
   ...
   */
  updateULogServiceMachineGroup(
    request?: UpdateULogServiceMachineGroupRequest
  ): Promise<UpdateULogServiceMachineGroupResponse> {
    const args = {
      Action: 'UpdateULogServiceMachineGroup',
      ...(request || {}),
    };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as UpdateULogServiceMachineGroupResponse
    );
  }
   ...
   */
  updateULogServiceTopicField(
    request?: UpdateULogServiceTopicFieldRequest
  ): Promise<UpdateULogServiceTopicFieldResponse> {
    const args = { Action: 'UpdateULogServiceTopicField', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as UpdateULogServiceTopicFieldResponse
    );
  }
}
