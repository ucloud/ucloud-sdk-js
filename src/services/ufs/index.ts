...
export default class UFSClient extends Client {
  ...
  addUFSVolumeMountPoint(
    request?: AddUFSVolumeMountPointRequest
   ...
   */
  createUFSVolume(
    request?: CreateUFSVolumeRequest
   ...
   */
  describeUFSVolume2(
    request?: DescribeUFSVolume2Request
  ...
  describeUFSVolumeMountpoint(
    request?: DescribeUFSVolumeMountpointRequest
  ...
  describeUFSVolumePrice(
    request?: DescribeUFSVolumePriceRequest
   ...
   */
  extendUFSVolume(
    request?: ExtendUFSVolumeRequest
   ...
   */
  removeUFSVolume(
    request?: RemoveUFSVolumeRequest
  ...
  removeUFSVolumeMountPoint(
    request?: RemoveUFSVolumeMountPointRequest
   ...
   */
  updateUFSVolumeInfo(
    request?: UpdateUFSVolumeInfoRequest
