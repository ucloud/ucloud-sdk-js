...
export default class UMemClient extends Client {
  ...
  checkUDredisSpaceAllowance(
    request?: CheckUDredisSpaceAllowanceRequest
  ...
  checkURedisAllowance(
    request?: CheckURedisAllowanceRequest
   ...
   */
  createUMemBackup(
    request?: CreateUMemBackupRequest
   ...
   */
  createUMemSpace(
    request?: CreateUMemSpaceRequest
  ...
  createUMemcacheGroup(
    request?: CreateUMemcacheGroupRequest
   ...
   */
  createURedisBackup(
    request?: CreateURedisBackupRequest
   ...
   */
  createURedisGroup(
    request?: CreateURedisGroupRequest
   ...
   */
  deleteUMemSpace(
    request?: DeleteUMemSpaceRequest
  ...
  deleteUMemcacheGroup(
    request?: DeleteUMemcacheGroupRequest
   ...
   */
  deleteURedisGroup(
    request?: DeleteURedisGroupRequest
  ...
  describeUDRedisProxyInfo(
    request?: DescribeUDRedisProxyInfoRequest
  ...
  describeUDRedisSlowlog(
    request?: DescribeUDRedisSlowlogRequest
   ...
   */
  describeUMemBackup(
    request?: DescribeUMemBackupRequest
  ...
  describeUMemBackupURL(
    request?: DescribeUMemBackupURLRequest
  ...
  describeUMemBlockInfo(
    request?: DescribeUMemBlockInfoRequest
   ...
   */
  describeUMemPrice(
    request?: DescribeUMemPriceRequest
   ...
   */
  describeUMemSpace(
    request?: DescribeUMemSpaceRequest
  ...
  describeUMemUpgradePrice(
    request?: DescribeUMemUpgradePriceRequest
  ...
  describeUMemcacheGroup(
    request?: DescribeUMemcacheGroupRequest
  ...
  describeUMemcachePrice(
    request?: DescribeUMemcachePriceRequest
  ...
  describeUMemcacheUpgradePrice(
    request?: DescribeUMemcacheUpgradePriceRequest
  ): Promise<DescribeUMemcacheUpgradePriceResponse> {
    const args = {
  ...
  describeURedisBackup(
    request?: DescribeURedisBackupRequest
  ...
  describeURedisBackupURL(
    request?: DescribeURedisBackupURLRequest
  ...
  describeURedisConfig(
    request?: DescribeURedisConfigRequest
   ...
   */
  describeURedisGroup(
    request?: DescribeURedisGroupRequest
   ...
   */
  describeURedisPrice(
    request?: DescribeURedisPriceRequest
  ...
  describeURedisSlowlog(
    request?: DescribeURedisSlowlogRequest
  ...
  describeURedisUpgradePrice(
    request?: DescribeURedisUpgradePriceRequest
  ...
  describeURedisVersion(
    request?: DescribeURedisVersionRequest
   ...
   */
  flushallURedisGroup(
    request?: FlushallURedisGroupRequest
   ...
   */
  getUMemSpaceState(
    request?: GetUMemSpaceStateRequest
  ...
  iSolationURedisGroup(
    request?: ISolationURedisGroupRequest
   ...
   */
  modifyUMemSpaceName(
    request?: ModifyUMemSpaceNameRequest
  ...
  modifyURedisGroupName(
    request?: ModifyURedisGroupNameRequest
  ...
  modifyURedisGroupPassword(
    request?: ModifyURedisGroupPasswordRequest
   ...
   */
  resizeUMemSpace(
    request?: ResizeUMemSpaceRequest
   ...
   */
  resizeURedisGroup(
    request?: ResizeURedisGroupRequest
  ...
  restartUMemcacheGroup(
    request?: RestartUMemcacheGroupRequest
   ...
   */
  restartURedisGroup(
    request?: RestartURedisGroupRequest
  ...
  updateURedisBackupStrategy(
    request?: UpdateURedisBackupStrategyRequest
