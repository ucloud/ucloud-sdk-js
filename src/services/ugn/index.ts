...
export default class UGNClient extends Client {
   ...
   */
  addRoutePolicy(
    request?: AddRoutePolicyRequest
  ): Promise<AddRoutePolicyResponse> {
    const args = { Action: 'AddRoutePolicy', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as AddRoutePolicyResponse
    );
  }
   ...
   */
  attachUGNNetworks(
    request?: AttachUGNNetworksRequest
  ): Promise<AttachUGNNetworksResponse> {
    const args = { Action: 'AttachUGNNetworks', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as AttachUGNNetworksResponse
    );
  }
  ...
  createSimpleUGNBwPackage(
    request?: CreateSimpleUGNBwPackageRequest
  ): Promise<CreateSimpleUGNBwPackageResponse> {
    const args = { Action: 'CreateSimpleUGNBwPackage', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as CreateSimpleUGNBwPackageResponse
    );
  }
  ...
  createUGN(request?: CreateUGNRequest): Promise<CreateUGNResponse> {
    const args = { Action: 'CreateUGN', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as CreateUGNResponse
    );
  }
  ...
  delUGN(request?: DelUGNRequest): Promise<DelUGNResponse> {
    const args = { Action: 'DelUGN', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as DelUGNResponse
    );
  }
  ...
  deleteRoutePolicy(
    ...
    const args = { Action: 'DeleteRoutePolicy', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as DeleteRoutePolicyResponse
    );
  }
   ...
   */
  deleteUGNBwPackage(
    request?: DeleteUGNBwPackageRequest
  ): Promise<DeleteUGNBwPackageResponse> {
    const args = { Action: 'DeleteUGNBwPackage', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as DeleteUGNBwPackageResponse
    );
  }
   ...
   */
  describeSimpleUGN(
    request?: DescribeSimpleUGNRequest
  ): Promise<DescribeSimpleUGNResponse> {
    const args = { Action: 'DescribeSimpleUGN', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as DescribeSimpleUGNResponse
    );
  }
   ...
   */
  detachUGNNetworks(
    request?: DetachUGNNetworksRequest
  ): Promise<DetachUGNNetworksResponse> {
    const args = { Action: 'DetachUGNNetworks', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as DetachUGNNetworksResponse
    );
  }
   ...
   */
  enableRoutePolicy(
    request?: EnableRoutePolicyRequest
  ): Promise<EnableRoutePolicyResponse> {
    const args = { Action: 'EnableRoutePolicy', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as EnableRoutePolicyResponse
    );
  }
   ...
   */
  getSimpleBuyBwPrice(
    request?: GetSimpleBuyBwPriceRequest
  ): Promise<GetSimpleBuyBwPriceResponse> {
    const args = { Action: 'GetSimpleBuyBwPrice', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as GetSimpleBuyBwPriceResponse
    );
  }
  ...
  getSimpleUGNBwPackages(
    request?: GetSimpleUGNBwPackagesRequest
  ): Promise<GetSimpleUGNBwPackagesResponse> {
    const args = { Action: 'GetSimpleUGNBwPackages', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as GetSimpleUGNBwPackagesResponse
    );
  }
   ...
   */
  getSwitchableBillingModes(
    request?: GetSwitchableBillingModesRequest
  ): Promise<GetSwitchableBillingModesResponse> {
    const args = { Action: 'GetSwitchableBillingModes', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as GetSwitchableBillingModesResponse
    );
  }
   ...
   */
  getUGNRouteTable(
    request?: GetUGNRouteTableRequest
  ): Promise<GetUGNRouteTableResponse> {
    const args = { Action: 'GetUGNRouteTable', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as GetUGNRouteTableResponse
    );
  }
   ...
   */
  listSimpleBwPackage(
    request?: ListSimpleBwPackageRequest
  ): Promise<ListSimpleBwPackageResponse> {
    const args = { Action: 'ListSimpleBwPackage', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as ListSimpleBwPackageResponse
    );
  }
  ...
  listUGN(request?: ListUGNRequest): Promise<ListUGNResponse> {
    const args = { Action: 'ListUGN', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as ListUGNResponse
    );
  }
   ...
   */
  listUGNRegions(
    request?: ListUGNRegionsRequest
  ): Promise<ListUGNRegionsResponse> {
    const args = { Action: 'ListUGNRegions', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as ListUGNRegionsResponse
    );
  }
   ...
   */
  modifyUGNBandwidth(
    request?: ModifyUGNBandwidthRequest
  ): Promise<ModifyUGNBandwidthResponse> {
    const args = { Action: 'ModifyUGNBandwidth', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as ModifyUGNBandwidthResponse
    );
  }
   ...
   */
  sendUGNApplyNetwork(
    request?: SendUGNApplyNetworkRequest
  ): Promise<SendUGNApplyNetworkResponse> {
    const args = { Action: 'SendUGNApplyNetwork', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as SendUGNApplyNetworkResponse
    );
  }
  ...
  ): Promise<UpdateRoutePolicyResponse> {
    const args = { Action: 'UpdateRoutePolicy', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as UpdateRoutePolicyResponse
    );
  }
}
