...
export default class UPFSClient extends Client {
   ...
   */
  createUPFSVolume(
    request?: CreateUPFSVolumeRequest
  ): Promise<CreateUPFSVolumeResponse> {
    const args = { Action: 'CreateUPFSVolume', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as CreateUPFSVolumeResponse
    );
  }
   ...
   */
  describeUPFSVolume(
    request?: DescribeUPFSVolumeRequest
  ): Promise<DescribeUPFSVolumeResponse> {
    const args = { Action: 'DescribeUPFSVolume', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as DescribeUPFSVolumeResponse
    );
  }
  ...
  describeUPFSVolumePrice(
    request?: DescribeUPFSVolumePriceRequest
  ): Promise<DescribeUPFSVolumePriceResponse> {
    const args = { Action: 'DescribeUPFSVolumePrice', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as DescribeUPFSVolumePriceResponse
    );
  }
  ...
  describeUPFSVolumeUpgradePrice(
    request?: DescribeUPFSVolumeUpgradePriceRequest
  ): Promise<DescribeUPFSVolumeUpgradePriceResponse> {
    const args = {
      Action: 'DescribeUPFSVolumeUpgradePrice',
      ...(request || {}),
    };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as DescribeUPFSVolumeUpgradePriceResponse
    );
  }
   ...
   */
  extendUPFSVolume(
    request?: ExtendUPFSVolumeRequest
  ): Promise<ExtendUPFSVolumeResponse> {
    const args = { Action: 'ExtendUPFSVolume', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as ExtendUPFSVolumeResponse
    );
  }
   ...
   */
  removeUPFSVolume(
    request?: RemoveUPFSVolumeRequest
  ): Promise<RemoveUPFSVolumeResponse> {
    const args = { Action: 'RemoveUPFSVolume', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as RemoveUPFSVolumeResponse
    );
  }
  ...
  updateUPFSVolumeInfo(
    request?: UpdateUPFSVolumeInfoRequest
  ): Promise<UpdateUPFSVolumeInfoResponse> {
    const args = { Action: 'UpdateUPFSVolumeInfo', ...(request || {}) };
    return this.invoke(new Request(args)).then(
      (resp) => resp.toObject() as UpdateUPFSVolumeInfoResponse
    );
  }
}
